...
$list = $commentC->showCommentsForArticle($IDart);
?>
<!DOCTYPE html>
<html lang="fr">
                    ...
                    <div class="article">
                        ...
                        <div class="comment-section">
                            ...
                            <div class="comment-form">
                                <textarea name="ContenuComm" id="ContenuComm" placeholder="Votre commentaire"></textarea>
                                <button class="icon-button" onclick="addComment(<?php echo $res['IDart']; ?>)">
                                    <i class='bx bx-send'></i>
                                </button>
                                <button class="icon-button" onclick="showComment(<?php echo $res['IDart']; ?>)">
