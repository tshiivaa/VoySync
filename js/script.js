document.addEventListener('DOMContentLoaded', function() {
 ...
 function handleLocationCardClick(location) {
  ...
  document.querySelector('h2').textContent = "Budget de " + location;
...
function handleTotalBudgetCardClick() {
  // Reload the page
  document.querySelector('h2').textContent = "Budget Total";
  location.reload();
}

function viewPhoto(base64Image) {
...
function handleModalClick(event) {
  ...
  // If the click target is the modal overlay itself (not its children), close the modal
